...
// Transformer layer structure with pointers
...
// Adam optimizer gradients structure
typedef struct AdamGradients {
...
typedef struct Transformer {
    ...
    AdamGradients_t *adam_gradients;
    int num_heads;
    Matrix_t *d_input;
    Matrix_t *d_output;
    int mini_batch_size;
...
void attention_head(Transformer_t *layer, Matrix_t *input);
